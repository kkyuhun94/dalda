EXP_NAME = "dalda-pets-base-prompt-adaptive-scaling-clip"
...
prompt_mode = "base" # Options : ["llm", "base"]
llm_prompt_path = None # Only for LLM prompt mode
...
scale = "adaptive" # Options : ["all_random", "adaptive", 0.1, 0.2, ..., 1.0]
